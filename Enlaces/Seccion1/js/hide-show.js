...
$("#btn-hortalizas").click(
    function () {
        ...
        $("#btn-tomates").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-papas").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-lechugas").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-cebollas").css("background-color","rgba(253, 122, 34, 0.548)");
        //mostrar
...
$("#btn-tomates").click(
    function () {
        ...
        $("#btn-hortalizas").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-papas").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-lechugas").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-cebollas").css("background-color","rgba(253, 122, 34, 0.548)");
        //mostrar
...
$("#btn-citricos").click(
    function () {
        ...
        $("#btn-melones").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-frutas-secas").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-platanos").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-manzanas").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-uvas").css("background-color","rgba(253, 122, 34, 0.548)");
        //mostrar
...
$("#btn-melones").click(
    function () {
        ...
        $("#btn-citricos").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-frutas-secas").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-platanos").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-manzanas").css("background-color","rgba(253, 122, 34, 0.548)");
        $("#btn-uvas").css("background-color","rgba(253, 122, 34, 0.548)");
